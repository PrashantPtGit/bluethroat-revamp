    ...
    >
      ...
      >
        <div style={{ position: 'relative' }}>
          <Blue size={680} mood="idle" />
          <div
            style={{
              position:      'absolute',
              inset:         0,
              background:    'linear-gradient(to right, #0D0F12 0%, #0D0F12 5%, rgba(13,15,18,0.88) 15%, rgba(13,15,18,0.55) 28%, rgba(13,15,18,0.2) 45%, transparent 62%)',
              pointerEvents: 'none',
              zIndex:        1,
            }}
          />
